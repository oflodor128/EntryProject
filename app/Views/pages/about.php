...
<header>
    ...
    <div class="heroe">
        ...
        <h1>This is us!!! <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2>Estamos explorando el potencial que exite</h2>
...
<section>
    ...
    <p>Entiendo el concepto</p>

    <p>Usa tu logica</p>

    <pre><code>Papaya DevOps</code></pre>
